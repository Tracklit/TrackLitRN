                ...
                {isLoading ? (
                  ...
                  <div className="space-y-4">
                    {upcomingMeets
                      ...
                      .map(meet => (
                      <Card key={meet.id} className="overflow-hidden hover:shadow-2xl transition-all duration-300" style={{ borderRadius: '6px', background: 'linear-gradient(135deg, #2d1b4e 0%, #4c2a7e 100%)', border: '0.5px solid rgba(148, 163, 184, 0.25)', boxShadow: '0 0 20px 8px rgba(102, 126, 234, 0.15), 0 25px 50px -12px rgba(0, 0, 0, 0.40), 0 15px 20px -5px rgba(0, 0, 0, 0.30)' }}>
                          ...
                          <div className="flex flex-col">
                            ...
                            <div className="flex flex-col space-y-2 mb-3">
                              <div className="flex items-center">
                                ...
                                <span className="text-white/80">{formatDate(meet.date)} • {formatTime(meet.date)}</span>
                              </div>
                              <div className="flex items-center">
                                <MapPin className="h-4 w-4 mr-2 text-white" />
                                <span className="text-white/80">{meet.location}</span>
                              </div>
                              {meet.websiteUrl && (
                                <div className="flex items-center">
                            ...
                            <div className="flex flex-wrap gap-2 my-3">
                              {meet.events?.map(event => (
                                <Badge key={event} className="bg-white/20 text-white hover:bg-white/30" style={{ borderRadius: '6px' }}>{event}</Badge>
                              ))}
                            </div>
                  ...
                  <Card className="overflow-hidden backdrop-blur-sm text-center p-8" style={{ borderRadius: '6px', background: 'linear-gradient(135deg, #2d1b4e 0%, #4c2a7e 100%)', border: '0.5px solid rgba(148, 163, 184, 0.25)', boxShadow: '0 0 20px 8px rgba(102, 126, 234, 0.15), 0 25px 50px -12px rgba(0, 0, 0, 0.40), 0 15px 20px -5px rgba(0, 0, 0, 0.30)' }}>
              ...
              <TabsContent value="calendar">
                {isProUser ? (
                  <>
                    ...
                    {selectedMeet && (
                      <div className="mt-6">
                        <Card className="overflow-hidden bg-gradient-to-br from-blue-800 to-purple-400 hover:shadow-2xl hover:shadow-blue-500/10 transition-all duration-300" style={{ borderRadius: '6px', boxShadow: '0 0 8px rgba(168, 85, 247, 0.2)' }}>
                          <CardContent className="p-4">
                            <div className="flex flex-col">
                              ...
                              <div className="flex flex-col space-y-2 mb-3">
                                <div className="flex items-center">
                                  <Calendar className="h-4 w-4 mr-2 text-white" />
                                  <span className="text-white/80">{formatDate(selectedMeet.date)} • {formatTime(selectedMeet.date)}</span>
                                </div>
                                <div className="flex items-center">
                                  <MapPin className="h-4 w-4 mr-2 text-white" />
                                  <span className="text-white/80">{selectedMeet.location}</span>
                                </div>
                              </div>
