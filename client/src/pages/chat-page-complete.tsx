...
// Enhanced Message Bubble Component with full functionality
      ...
      {reactionAnimation && (
        <div className={cn(
          ...
          <div className="relative animate-bounce">
            ...
            <div className="absolute -bottom-1 -left-1 w-1.5 h-1.5 bg-blue-400 rounded-full animate-pulse delay-150"></div>
          </div>
        </div>
      )}
    </div>
