          ...
          {toolCards.map((card, index) => (
            card.disabled ? (
              ...
              <Link key={index} href={card.href}>
                <Card 
                  className={`cursor-pointer h-[140px] mx-auto mb-2 overflow-hidden relative ${card.gradient} group hover:scale-105 transition-all duration-300 border border-gray-300`}
                >
                  {/* Content Area */}
                  <CardContent className="p-2.5 relative h-full flex flex-col justify-center">
                    <div className="flex flex-col items-center text-center gap-2">
