        ...
        <section className="mb-4">
          <div className="max-w-2xl mx-auto">
            {categoryCards.map((card, index) => 
              card.disabled ? (
                <Card key={index} className={`h-[90px] overflow-hidden opacity-30 cursor-not-allowed bg-muted/30 shadow-2xl ${index > 0 ? 'mt-2' : ''}`} style={{ border: '0.5px solid rgba(168, 85, 247, 0.25)' }}>
                ...
                <Link href={card.href} key={index}>
                  <Card className={`cursor-pointer shadow-2xl h-[90px] overflow-hidden group relative bg-primary/5 ${index > 0 ? 'mt-2' : ''}`} style={{ border: '0.5px solid rgba(168, 85, 247, 0.25)' }}>
