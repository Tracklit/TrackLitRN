...
export function HamburgerMenu({ className }: HamburgerMenuProps) {
  ...
  return (
    <div className={cn("block lg:hidden", className)}>
      ...
      <div
        className={cn(
          "fixed inset-0 z-[5] bg-background/80 backdrop-blur-sm transition-opacity duration-300",
      ...
      <div
        className={cn(
          "fixed top-0 left-0 bottom-0 z-[5] w-3/4 max-w-xs bg-gray-900 shadow-xl transition-transform duration-300 ease-in-out",
