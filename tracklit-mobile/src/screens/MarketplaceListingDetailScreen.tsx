...
const createStyles = (t: ThemeValues) => StyleSheet.create({
  ...
  card: { marginBottom: 0 },
  hero: { width: '100%', height: 220, borderRadius: themeStatic.borderRadius.lg },
  heroPlaceholder: {
    width: '100%',
    height: 220,
  ...
  heroBadge: { position: 'absolute', top: themeStatic.spacing.md, left: themeStatic.spacing.md },
  rowBetween: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  ratingRow: { flexDirection: 'row', alignItems: 'center', gap: themeStatic.spacing.xs },
  coachRow: { flexDirection: 'row', alignItems: 'center', gap: themeStatic.spacing.sm },
  tagRow: { flexDirection: 'row', flexWrap: 'wrap', gap: themeStatic.spacing.xs },
  qtyRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: themeStatic.spacing.sm },
  qtyControls: { flexDirection: 'row', alignItems: 'center', gap: themeStatic.spacing.sm },
  qtyBtn: {
    width: 36,
    height: 36,
    borderRadius: 18,
