...
- **Announcement Ticker Hide/Unhide Feature (November 15, 2025)**: Implemented collapsible announcement ticker with smooth animations
  - **Collapsed "Feed" tab**: When X button is clicked, ticker slides up and fades out, collapsing to 8px slim tab with dark blue gradient background, 16px rounded corners, and chevron icon
  - **Smooth animations**: 150ms slide-up/fade-out on collapse, 250ms slide-down/fade-in on expand with ease-out timing
  - **Premium dark blue design**: Tab has dark navy-to-blue gradient (rgba(15,23,42) → rgba(30,58,138)), subtle shadow, and "Feed" text label
  ...
  - **Removed Globe icon**: Cleaned up top navigation by removing ticker toggle button
