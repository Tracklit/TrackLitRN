...
## Overview
TrackLit is a comprehensive web application for track and field athletes and coaches. It offers training program management, meet scheduling, performance tracking, and advanced video analysis. The application aims to enhance athletic performance using modern web technologies, including MediaPipe-based biomechanical analysis and AI-powered coaching insights, aspiring to be a leading platform for athletic development.
...
- **Core Features**:
    ...
    - Real-time chat with filtering and presence indicators.
...
- **UI/UX**: Clean, modern design with consistent 6px corner rounding, unified card styling, dark slate theme, and purple-pink gradient accents. Mobile-first approach with touch-optimized interactions and intuitive navigation. Consistent visual elements across sections.
- **Performance**: Client-side image compression (WebP), lazy loading, server-side image processing, and optimized data fetching with skeleton loaders.
